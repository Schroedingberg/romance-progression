...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_37867 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_37867(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_37871 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_37871(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37873 = (function (reader,ch){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_37873(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37876 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_37876(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37877 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_37877(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37889 = (function (reader){
var x__5350__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_37889(reader);
}
});
...
var G__38017 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null, );
var G__38018 = s.append(c);
c = G__38017;
s = G__38018;
continue;
}
