...
var G__38912 = o;
reagent.impl.template.goog$module$goog$object.set(G__38912,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
while (G__39750__i < G__39750__a.length) {G__39750__a[G__39750__i] = arguments[G__39750__i + 0]; ++G__39750__i;}
  args = new cljs.core.IndexedSeq(G__39750__a,0,null);
} 
return G__39744__delegate.call(this,args);};
G__39744.cljs$lang$maxFixedArity = 0;
G__39744.cljs$lang$applyTo = (function (arglist__39752){
...
var G__38981 = o;
reagent.impl.template.goog$module$goog$object.set(G__38981,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__39002 = props;
var G__39002__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39002,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__39002);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39002__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39043 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39043,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39043;
}
})(),id_class);
...
var G__39056 = (cljs.core.count(argv) - first_child);
switch (G__39056) {
case (0):
...
var vec__39074 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39074,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39074,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39074,(2),null);
...
var temp__5827__auto___39822 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39822 == null)){
} else {
var key_39824 = temp__5827__auto___39822;
(jsprops.key = key_39824);
}
...
var temp__5827__auto___39826 = reagent.impl.util.react_key_from_vec(v);
if((temp__5827__auto___39826 == null)){
} else {
var key_39827 = temp__5827__auto___39826;
(jsprops.key = key_39827);
}
...
var temp__5827__auto___39835 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5827__auto___39835 == null)){
} else {
var key_39836 = temp__5827__auto___39835;
(jsprops.key = key_39836);
}
...
var temp__5827__auto___39854 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39854 == null)){
} else {
var key_39855 = temp__5827__auto___39854;
(jsprops.key = key_39855);
}
...
var temp__5827__auto___39856 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5827__auto___39856 == null)){
} else {
var key_39857 = temp__5827__auto___39856;
(jsprops.key = key_39857);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39292_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39292_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39337 = reagent.ratom.check_derefs((function (){
...
break;
default:
var G__39884 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
...
*/
reagent.impl.template.t_reagent$impl$template39573 = (function (opts,id,fn_to_element,parse_fn,meta39574){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39573.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39575,meta39574__$1){
var self__ = this;
var _39575__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39573(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta39574__$1));
}));

(reagent.impl.template.t_reagent$impl$template39573.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39575){
var self__ = this;
var _39575__$1 = this;
return self__.meta39574;
}));

(reagent.impl.template.t_reagent$impl$template39573.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39573.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39573.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template39573.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39573.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39573.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta39574","meta39574",498135428,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template39573.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39573.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39573");

(reagent.impl.template.t_reagent$impl$template39573.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template39573");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39573.
 */
reagent.impl.template.__GT_t_reagent$impl$template39573 = (function reagent$impl$template$__GT_t_reagent$impl$template39573(opts,id,fn_to_element,parse_fn,meta39574){
return (new reagent.impl.template.t_reagent$impl$template39573(opts,id,fn_to_element,parse_fn,meta39574));
});
...
return (new reagent.impl.template.t_reagent$impl$template39573(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
