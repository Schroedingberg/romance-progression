...
var i_36152 = (self__.level + (1));
while(true){
if((i_36152 <= (new_level + (1)))){
(update[i_36152] = self__.header);

var G__36154 = (i_36152 + (1));
i_36152 = G__36154;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_36155 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_36155[i]));
} else {
x__$2.forward.push((((i < links_36155.length))?(links_36155[i]):null));
}

if((i < links_36155.length)){
(links_36155[i] = x__$2);
} else {
links_36155.push(x__$2);
}
...
var i_36168 = (0);
while(true){
if((i_36168 <= self__.level)){
var links_36171 = (update[i_36168]).forward;
if((x__$1 === (((i_36168 < links_36171.length))?(links_36171[i_36168]):null))){
(links_36171[i_36168] = (x__$1.forward[i_36168]));

var G__36173 = (i_36168 + (1));
i_36168 = G__36173;
continue;
} else {
var G__36174 = (i_36168 + (1));
i_36168 = G__36174;
continue;
}
} else {
...
var G__36186 = nx;
var G__36187 = (level__$1 - (1));
x = G__36186;
level__$1 = G__36187;
continue;
} else {
var G__36188 = x;
var G__36189 = (level__$1 - (1));
x = G__36188;
level__$1 = G__36189;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__36195 = nx;
var G__36196 = (level__$1 - (1));
x = G__36195;
level__$1 = G__36196;
continue;
} else {
var G__36199 = x;
var G__36200 = (level__$1 - (1));
x = G__36199;
level__$1 = G__36200;
continue;
}
