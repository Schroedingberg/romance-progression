...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32739 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32739(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_32748 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_32748(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32754 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32754(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32774 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32774(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32783 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32783(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32801 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32801(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32723,callback){
var map__32725 = p__32723;
var map__32725__$1 = cljs.core.__destructure_map(map__32725);
var input = map__32725__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32725__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32725__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
